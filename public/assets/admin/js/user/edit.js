...
function beforeformRequest(formData, jqForm, options) {
    ...
    $("#"+current_form_id+" #notify").notification({caption: "We are processing your information update. Please wait.",sticky:true});
}
