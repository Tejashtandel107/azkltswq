...
<div class="page-content fade-in-up">
    <div class="ibox mb-2">
        ...
        <form action="{{ route('user.outwards.index') }}" method="GET" id="form-filter" autocomplete="off">
            <div id="notify"></div>
            ...
            <div class="flexbox mb-2">
                <div class="form-inline">
                    ...
                    <select name="p" class="form-control mr-2" onchange="formsubmit()">
                        @foreach(['50' => '50', '100' => '100', '150' => '150', '200' => '200', '300' => '300'] as $value => $label)
                            <option value="{{ $value }}" @selected($show == $value)>{{ $label }}</option>
                        @endforeach
                    </select>
...
@section('page-scripts')
	<script src="{{ asset('/assets/web/js/outwards/index.js') }}"></script>
@endsection
