...
@section('page-css')
    <link rel="stylesheet" href="{{ asset('/assets/admin/css/reports/fullledger-reports.css') }}">
@endsection
...
<div class="page-content fade-in-up">
    <div class="ibox mb-2 noprint">
        <div class="ibox-body py-3">
            <form action="{{ route('admin.reports.full-ledger.show') }}" method="get" id="form-filter" autocomplete="off">
                <div id="notify"></div>
                <div class="row">                                  
                            ...
                            <div class="d-flex flex-wrap">
                                ...
                                <div class="mr-2 mb-2">
                                    ...
                                    <select name="c" class="form-control">
                                        ...
                                        <option value="all_customer" @selected(request('c') == 'all_customer')>All Customers</option>
                                        @foreach($customers->pluck('fullname', 'customer_id') as $id => $fullname)
                                            <option value="{{ $id }}" @selected(request('c') == $id)>{{ $fullname }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="mr-2 mb-2">
                                ...
                                <div class="mr-2 mb-2">
                                    ...
                                    <div class="input-group-icon input-group-icon-left">
                                        ...
                                        <input type="text" name="q" class="form-control" placeholder="Vakkal,Item,Marka,Quantity" value="{{ ($request->q ?? '') }}">
                                    </div>
                                </div>      
                                <div class="mr-2 mb-2">
...
@section('page-scripts')
    <script src="{{ asset('/assets/admin/js/reports/full-ledger.js') }}"></script>
@endsection