...
@section('page-css')
    <link rel="stylesheet" href="{{ asset('/assets/admin/css/reports/insurance-reports.css') }}">
@endsection
...
<div class="page-content fade-in-up">
    <div class="ibox mb-2 noprint">
        <div class="ibox-body py-3">
            <form method="GET" action="{{ route('admin.reports.insurance-report.show') }}" id="insurance-form">
                <div id="notify"></div>
                <div class="row">                                  
                            ...
                            <div class="d-flex flex-wrap">
                                <div class="mr-2 mb-2" style="width: 270px;">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="text" name="to" class="form-control datepicker" placeholder="To" autocomplete="off" value="{{ ($request->to ?? '') }}">
                                    </div>        
                                </div>
                                <div class="form-group mr-2 mb-2">
                                    ...
                                    <select name="c" class="form-control" required>
                                        ...
                                        @foreach($customers->pluck('fullname','customer_id') as $id => $fullname)
                                            <option value="{{ $id }}" @selected(request('c') == $id)>
                                                {{ $fullname }}
                                            </option>
                                        @endforeach
                                    </select>
...
@section('page-scripts')
    <script src="{{ asset('/assets/admin/js/reports/insurance.js') }}"></script>
@endsection